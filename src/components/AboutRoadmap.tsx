...
const steps = [
    {
        id: "2015",
        title: "Inception",
        description: "Founded with a vision to disrupt the rigid legacy ERP market with flexible, cloud-native solutions.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "2018",
        title: "Expansion",
        description: "Expanded globally, serving enterprise clients across manufacturing, retail, and healthcare sectors.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "2021",
        title: "AI Revolution",
        description: "Pioneered the integration of Generative AI and machine learning directly into core ERP workflows.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "2025",
        title: "Future Ready",
        description: "Leading the charge towards autonomous enterprise operations and intelligent decision-making.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        A decade of innovation, driven by a relentless pursuit of excellence.
                    </motion.p>
                </div>
                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="bg-slate-800/80 backdrop-blur-sm p-8 rounded-2xl border border-slate-700 shadow-xl hover:shadow-2xl hover:bg-slate-750 transition-all text-center h-full flex flex-col items-center hover:-translate-y-2 duration-300">
                                    {/* Step Number Circle */}
                                    <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${step.color} text-slate-900 font-bold text-xl flex items-center justify-center mb-6 shadow-lg shadow-cyan-500/20 group-hover:scale-110 transition-transform duration-300 relative z-10`}>
                                        {step.id}
