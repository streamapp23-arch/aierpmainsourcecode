...
const steps = [
    {
        id: "01",
        title: "Analyze",
        description: "Deep dive into your current processes to identify bottlenecks and AI opportunities.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Strategize",
        description: "Design a transformation roadmap with clear KPIs and measurable outcomes.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Transform",
        description: "Implement AI-powered solutions and optimize workflows for maximum efficiency.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Sustain",
        description: "Continuous monitoring and improvement to maintain competitive advantage.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From process inefficiency to AI-powered excellence in 4 proven phases.
                    </motion.p>
                </div>
...
export default ConsultingRoadmap;
