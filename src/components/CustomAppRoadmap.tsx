...
const steps = [
    {
        id: "01",
        title: "Discovery",
        description: "We map your unique workflows and identify opportunities for AI-powered automation.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Design",
        description: "Create clickable prototypes and technical architecture tailored to your needs.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Develop",
        description: "Agile sprints with weekly demos. See your custom app come to life in real-time.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Deploy",
        description: "Launch your MVP, train your team, and iterate based on real user feedback.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From idea to production-ready application in 4 strategic phases.
                    </motion.p>
                </div>
...
export default CustomAppRoadmap;
