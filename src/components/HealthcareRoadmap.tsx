...
const steps = [
    {
        id: "01",
        title: "Digitize",
        description: "Transition from paper records to secure, interoperable Electronic Health Records (EHR).",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Connect",
        description: "Integrate disparate systems (EHR, LIS, RIS) for seamless patient data flow.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Analyze",
        description: "Leverage AI to derive clinical insights and operational efficiencies from data.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Care",
        description: "Deliver personalized, value-based care with remote monitoring and patient engagement.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From legacy systems to connected care in 4 strategic phases.
                    </motion.p>
                </div>
...
export default HealthcareRoadmap;
