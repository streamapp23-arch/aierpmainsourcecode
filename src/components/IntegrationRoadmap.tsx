...
const steps = [
    {
        id: "01",
        title: "Assess",
        description: "We audit your data quality and identify high-ROI use cases.",
        color: "from-blue-400 to-cyan-300"
    },
    {
        id: "02",
        title: "Connect",
        description: "Secure API connections to your ERP (SAP, Oracle, etc.).",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "03",
        title: "Train",
        description: "Fine-tune models on your specific enterprise data.",
        color: "from-teal-300 to-emerald-300"
    },
    {
        id: "04",
        title: "Deploy",
        description: "Roll out to production with monitoring and governance.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        A proven path to production AI.
                    </motion.p>
                </div>
