...
const steps = [
    {
        id: "01",
        title: "Map",
        description: "Document all systems, data flows, and integration requirements across your ecosystem.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Design",
        description: "Architect scalable integration patterns with API-first and event-driven approaches.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Connect",
        description: "Build robust integrations with real-time sync, error handling, and monitoring.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Maintain",
        description: "Ongoing monitoring, optimization, and evolution as your systems grow.",
...
const IntegrationServicesRoadmap = () => {
    return (
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From fragmented systems to unified ecosystem in 4 proven phases.
                    </motion.p>
                </div>
...
export default IntegrationServicesRoadmap;
