...
const steps = [
    {
        id: "01",
        title: "Track",
        description: "Real-time visibility into every shipment, vehicle, and inventory item across the supply chain.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Optimize",
        description: "AI-driven route planning and load balancing to reduce fuel costs and delivery times.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Automate",
        description: "Streamline warehouse operations with automated picking, packing, and sorting systems.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Predict",
        description: "Forecast demand and supply chain disruptions before they impact your bottom line.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From reactive logistics to predictive supply chain in 4 strategic phases.
                    </motion.p>
                </div>
...
export default LogisticsRoadmap;
