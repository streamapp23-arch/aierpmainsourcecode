...
const steps = [
    {
        id: "01",
        title: "Onboard",
        description: "Seamless transition with full system audit and knowledge transfer from your team.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Monitor",
        description: "24/7 AI-powered monitoring with predictive alerts before issues become problems.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Optimize",
        description: "Continuous performance tuning and AI-driven recommendations for improvement.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Evolve",
        description: "Proactive upgrades, feature additions, and strategic roadmap planning.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From day one to continuous excellence in 4 strategic phases.
                    </motion.p>
                </div>
...
export default ManagedServicesRoadmap;
