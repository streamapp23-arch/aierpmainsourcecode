...
const steps = [
    {
        id: "01",
        title: "Assess",
        description: "Analyze current manufacturing processes, bottlenecks, and digitalization opportunities.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Architect",
        description: "Design smart factory blueprint with IoT sensors, AI analytics, and ERP integration.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Implement",
        description: "Deploy connected systems, automate workflows, and train teams on new processes.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Optimize",
        description: "Continuous improvement with predictive maintenance and real-time performance monitoring.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From traditional factory to Industry 4.0 in 4 proven phases.
                    </motion.p>
                </div>
...
export default ManufacturingRoadmap;
