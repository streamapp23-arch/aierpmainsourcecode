...
const steps = [
    {
        id: "01",
        title: "Strategy",
        description: "Define mobile requirements, user personas, and business objectives for your app.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Design",
        description: "Create intuitive UX/UI with native platform patterns and accessibility standards.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Develop",
        description: "Build native or cross-platform apps with offline-first architecture and security.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Deploy",
        description: "Launch to app stores with MDM integration, analytics, and continuous updates.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From concept to app store in 4 strategic phases.
                    </motion.p>
                </div>
...
export default MobilityRoadmap;
