...
const steps = [
    {
        id: "01",
        title: "Monitor",
        description: "Deploy IoT sensors across rigs, pipelines, and refineries for real-time asset visibility.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Analyze",
        description: "Process seismic and operational data with AI to optimize exploration and production.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Predict",
        description: "Forecast equipment failures and maintenance needs to prevent costly downtime.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Automate",
        description: "Implement autonomous drilling and remote operations to enhance safety and efficiency.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From digital oilfield to autonomous operations in 4 strategic phases.
                    </motion.p>
                </div>
