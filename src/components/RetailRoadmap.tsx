...
const steps = [
    {
        id: "01",
        title: "Unify",
        description: "Connect online and offline channels into a single, real-time commerce platform.",
        color: "from-sky-400 to-blue-300"
    },
    {
        id: "02",
        title: "Personalize",
        description: "Leverage AI to deliver hyper-personalized experiences across every touchpoint.",
        color: "from-blue-300 to-cyan-300"
    },
    {
        id: "03",
        title: "Optimize",
        description: "Streamline inventory, supply chain, and fulfillment with intelligent automation.",
        color: "from-cyan-300 to-teal-300"
    },
    {
        id: "04",
        title: "Scale",
        description: "Expand to new markets and channels with a flexible, cloud-native architecture.",
        ...
        <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-20">
                    ...
                    >
                        From fragmented channels to unified commerce in 4 strategic phases.
                    </motion.p>
                </div>
