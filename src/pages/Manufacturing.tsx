  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-cyan-500/20">
      ...
      <section className="relative pt-16 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 px-4 overflow-hidden bg-gradient-to-br from-cyan-900 via-blue-900 to-slate-900">
        ...
        <div className="container mx-auto max-w-6xl relative z-10 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight mb-6 sm:mb-8 leading-tight animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Tomorrow, Today</span>
          </h1>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-2xl mx-auto px-4 sm:px-0 leading-relaxed">
              Hover over the cards to see how smart manufacturing transforms production chaos into precision.
            </p>
          </div>
            ...
            <FlipCard
              frontContent={
                <>
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">Reactive Maintenance</h3>
                  <p className="text-slate-500">Machines break unexpectedly. Production stops. Millions lost.</p>
                </>
              }
              backContent={
                <>
                  <Brain className="h-12 w-12 mb-4 text-white/90" />
                  <h3 className="text-2xl font-bold mb-2">Predictive Maintenance</h3>
                  <p className="text-blue-100">AI predicts failures before they happen. Schedule repairs during planned downtime.</p>
                </>
              }
            />
            <FlipCard
              frontContent={
                <>
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">Zero Visibility</h3>
                  <p className="text-slate-500">No idea what's happening on the shop floor until it's too late.</p>
                </>
              }
              backContent={
                <>
                  ...
                  <p className="text-blue-100">Live dashboards show every machine, every line, every metric—instantly.</p>
                </>
              }
            />
            <FlipCard
              frontContent={
                <>
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">Manual Data Collection</h3>
                  <p className="text-slate-500">Workers spend hours logging production data on clipboards.</p>
                </>
              }
              backContent={
                <>
                  <Cpu className="h-12 w-12 mb-4 text-white/90" />
                  <h3 className="text-2xl font-bold mb-2">Automated Data Capture</h3>
                  <p className="text-blue-100">IoT sensors automatically track production, quality, and performance.</p>
                </>
              }
            />
            <FlipCard
              frontContent={
                <>
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">Siloed Systems</h3>
                  <p className="text-slate-500">Shop floor and ERP don't talk. Data lives in spreadsheets.</p>
                </>
              }
              backContent={
                <>
                  <Zap className="h-12 w-12 mb-4 text-white/90" />
                  <h3 className="text-2xl font-bold mb-2">Unified Platform</h3>
                  <p className="text-blue-100">MES, ERP, and IoT integrated for seamless data flow and automation.</p>
                </>
              }
            />
          </div>
          ...
          <div className="mt-12 p-8 bg-gradient-to-r from-cyan-50 to-blue-50 border-l-4 border-cyan-500 rounded-xl">
            <p className="text-center text-lg font-semibold text-slate-900">
              <span className="text-cyan-600">Industry Fact:</span> Smart factories reduce unplanned downtime by 50% and increase productivity by 30% through predictive analytics and automation.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 px-4 sm:px-0">Real impact from Industry 4.0 transformation</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <Card className="border-0 shadow-xl hover:-translate-y-2 transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="text-slate-600 font-medium">Productivity Increase</div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-xl hover:-translate-y-2 transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="text-slate-600 font-medium">Less Downtime</div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-xl hover:-translate-y-2 transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="text-slate-600 font-medium">Quality Improvement</div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-xl hover:-translate-y-2 transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="text-slate-600 font-medium">Visibility</div>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1">
                <p className="text-lg text-slate-700 mb-4 italic leading-relaxed">
                  "We implemented AIERP's smart manufacturing solution across 3 plants. Predictive maintenance alone saved us $2.8M in the first year by preventing catastrophic failures. Real-time production monitoring cut our cycle time by 22%."
                </p>
                <div className="font-semibold text-slate-900">David Martinez</div>
                <div className="text-slate-600">VP of Manufacturing, Automotive Supplier</div>
              </div>
            </div>
          </Card>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 bg-slate-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 px-4 sm:px-0">Industry 4.0 technologies for modern factories</p>
          </div>
            ...
            {[
              {
                ...
                description: "AI-powered algorithms analyze sensor data to predict equipment failures weeks in advance. Schedule maintenance during planned downtime, not emergencies.",
                icon: Brain,
                color: "from-cyan-400 to-blue-400"
              },
              {
                title: "Real-Time Production Monitoring",
                description: "Live dashboards show OEE, cycle times, quality metrics, and bottlenecks across all production lines with drill-down capabilities.",
                icon: Activity,
                color: "from-blue-400 to-indigo-400"
              },
              {
                title: "IoT Sensor Integration",
                description: "Connect machines, tools, and equipment with industrial IoT sensors for automated data collection and process optimization.",
                icon: Cpu,
                color: "from-purple-400 to-pink-400"
              },
              {
                title: "MES & ERP Integration",
                description: "Seamless connection between Manufacturing Execution Systems and SAP/Oracle ERP for unified planning and execution.",
                icon: Settings,
                color: "from-green-400 to-emerald-400"
              },
              {
                title: "Quality Management Systems",
                description: "Automated quality control with AI vision inspection, statistical process control, and real-time defect tracking.",
                icon: Shield,
                color: "from-orange-400 to-red-400"
              },
              {
                title: "Digital Twin Technology",
                description: "Virtual replicas of production lines for simulation, optimization, and what-if analysis before making physical changes.",
                icon: Factory,
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4 px-4 sm:px-0">Industry 4.0 Technologies</h2>
            <p className="text-base sm:text-lg md:text-xl text-slate-600 px-4 sm:px-0">Modern tools for smart factories</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-12">
            {[
              { metric: "IoT Sensors", label: "Real-Time Data", icon: Cpu },
              { metric: "AI/ML", label: "Predictive Analytics", icon: Brain },
              { metric: "Cloud MES", label: "Scalable Platform", icon: Factory }
            ].map((stat, i) => (
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 bg-gradient-to-br from-cyan-900 to-blue-900">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full mb-8 backdrop-blur-sm border border-white/20">
            ...
            <span className="text-cyan-100 font-semibold text-sm">TRANSFORM YOUR FACTORY</span>
          </div>
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-cyan-100 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
            Get a free smart factory assessment and discover how Industry 4.0 can transform your manufacturing operations.
          </p>
          <div className="pt-4">
          ...
          <p className="mt-8 text-cyan-200 font-medium">
            ⚡ Assessment in 48 hours • ✓ No obligation • ✓ ROI analysis included
          </p>
        </div>
      </section>
