    ...
    return (
        <div className="min-h-screen bg-white font-sans selection:bg-brand-blue/20">
            ...
            <section className="relative pt-16 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 px-4 overflow-hidden bg-white">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-yellow-100/50 via-transparent to-transparent" />
                ...
                <div className="container mx-auto max-w-6xl relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-yellow-50 border border-yellow-100 text-yellow-700 text-xs sm:text-sm font-semibold mb-6 sm:mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500 shadow-sm">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold text-slate-900 tracking-tight mb-6 sm:mb-8 leading-tight animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-yellow-500">with Zoho CRM</span>
                    </h1>
                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        <FlipCard
                            ...
                            backContent={
                                <div className="text-left w-full h-full flex flex-col justify-center">
                                    <h3 className="text-xl font-bold mb-4 text-white">Omnichannel Mastery</h3>
                        ...
                        <FlipCard
                            frontContent={
                                <>
                                    <div className="h-16 w-16 rounded-2xl bg-yellow-50 flex items-center justify-center mb-6">
                                        <Repeat className="h-8 w-8 text-yellow-600" />
                                    </div>
                            ...
                            backContent={
                                <div className="text-left w-full h-full flex flex-col justify-center">
                                    <h3 className="text-xl font-bold mb-4 text-white">Blueprint Engine</h3>
                                    <ul className="space-y-2">
                                        <li className="flex items-start gap-2 text-sm text-blue-50">
                                            <CheckCircle className="w-4 h-4 mt-0.5 shrink-0" />
                        ...
                        <FlipCard
                            ...
                            backContent={
                                <div className="text-left w-full h-full flex flex-col justify-center">
                                    <h3 className="text-xl font-bold mb-4 text-white">Zia Intelligence</h3>
                                    <ul className="space-y-2">
                                        <li className="flex items-start gap-2 text-sm text-blue-50">
                                            <CheckCircle className="w-4 h-4 mt-0.5 shrink-0" />
            ...
            <section className="py-20 px-4 bg-white">
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-none relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-24 h-24 bg-yellow-50/50 rounded-bl-full -mr-12 -mt-12 transition-all duration-500 group-hover:scale-150 group-hover:bg-yellow-600/5 -z-0" />
                            <div className="relative z-10 text-left">
                                <div className="w-16 h-16 bg-yellow-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-yellow-600 transition-all duration-300 shadow-sm">
                                    <Workflow className="w-8 h-8 text-yellow-600 group-hover:text-white" />
                                </div>
                                <h3 className="text-2xl font-bold text-slate-900 mb-4">Mandatory Data</h3>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3 text-slate-600 text-base">
                                        <CheckCircle className="w-5 h-5 text-yellow-500 mt-1 shrink-0" />
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-none relative overflow-hidden group">
                            ...
                            <div className="relative z-10 text-left">
                                <div className="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-green-600 transition-all duration-300 shadow-sm">
                                    <Bot className="w-8 h-8 text-green-600 group-hover:text-white" />
                                </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="flex-1">
                            <div className="relative">
                                <div className="absolute top-10 left-10 w-24 h-24 bg-yellow-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob"></div>
                                <div className="absolute top-10 right-10 w-24 h-24 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
                                <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-100 relative z-10">
                                    ...
                                    <ul className="space-y-4">
                                        <li className="flex items-center gap-3 text-slate-600">
                                            <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs">1</div>
                                            <span>Requirement Analysis & Consulting</span>
                                        </li>
                                        <li className="flex items-center gap-3 text-slate-600">
                                            <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs">2</div>
                                            <span>Data Migration & Cleansing</span>
                                        </li>
                                        <li className="flex items-center gap-3 text-slate-600">
                                            <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs">3</div>
                                            <span>Customization (Canvas, Blueprint, Deluge)</span>
                                        </li>
                                        <li className="flex items-center gap-3 text-slate-600">
                                            <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs">4</div>
            ...
            {/* Final CTA */}
            <section className="py-12 sm:py-16 md:py-24 px-4 bg-gradient-to-br from-brand-blue to-yellow-600">
